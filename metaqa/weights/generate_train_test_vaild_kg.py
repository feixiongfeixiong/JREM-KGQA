...
data=get_data('../data/PQL_KG2/PQL2-KB.txt')
train_data,test_data,valid_data=get_train_test_and_valid(data)
write_data('../data/PQL_KG2/train.txt', train_data)
write_data('../data/PQL_KG2/test.txt', test_data)
write_data('../data/PQL_KG2/valid.txt', valid_data)