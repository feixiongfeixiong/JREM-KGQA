...
if __name__ == '__main__':
    ...
    parser.add_argument("--hops", type=str, default='1', nargs="?",
                    help="hops")
    ...
    if 'half' in args.dataset:
        data_file_path = '../data/QA_data/MetaQA' + '/qa_' + 'train' + '_' + args.hops + 'hop_half.txt'
    else:
        data_file_path = '../data/QA_data/MetaQA' + '/qa_' + 'train' + '_' + args.hops + 'hop.txt'
