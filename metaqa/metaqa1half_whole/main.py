...
parser.add_argument('--kg_dataset', type=str, default='MetaQA')

parser.add_argument('--mode', type=str, default='train')
parser.add_argument('--batch_size', type=int, default=256)
parser.add_argument('--dropout', type=float, default=0.2)#0.1
parser.add_argument('--entdrop', type=float, default=0.2)#0.1
parser.add_argument('--reldrop', type=float, default=0.3)#0.2
parser.add_argument('--scoredrop', type=float, default=0.3)#0.2
