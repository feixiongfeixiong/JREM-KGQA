...
def load_data_gongju(datadir):

    data_file = open(datadir, 'r')
    data_array = []
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="PQL3H_half", nargs="?",
                    help="Which dataset to use: FB15k, FB15k-237, WN18 or WN18RR.")
    parser.add_argument("--hops", type=str, default='3', nargs="?",
                    help="hops")
    parser.add_argument("--num_iterations", type=int, default=2000, nargs="?",
                    help="Number of iterations.")
    parser.add_argument("--batch_size", type=int, default=64, nargs="?",
                    help="Batch size.")
    parser.add_argument("--lr", type=float, default=0.0002, nargs="?",
                    help="Learning rate.")
    ...
    if 'half' in args.dataset:
        data_file_path = '../data/QA_data/PQL3H' + '/qa_' + 'train' + '_' + args.hops + 'hop_half.txt'
    else:
        data_file_path = '../data/QA_data/PQL3H' + '/qa_' + 'train' + '_' + args.hops + 'hop.txt'
    metaqa_train=load_data_gongju(data_file_path)
    print(data_file_path)
    d = Data(metaqa_train,data_dir=data_dir, reverse=True)
