...
parser.add_argument('--kg_dataset', type=str, default='PQL3H')

parser.add_argument('--mode', type=str, default='train')
parser.add_argument('--batch_size', type=int, default=16)
parser.add_argument('--dropout', type=float, default=0.1)#0.1
parser.add_argument('--entdrop', type=float, default=0.1)#0.1
parser.add_argument('--reldrop', type=float, default=0.1)#0.1
parser.add_argument('--scoredrop', type=float, default=0.2)#0.2
...
def train(kg_dataset,kgtype,data_path, entity_path, relation_path, entity_dict, relation_dict, neg_batch_size, batch_size, shuffle, num_workers, nb_epochs, embedding_dim, hidden_dim, relation_dim, gpu, use_cuda,patience, freeze, validate_every, num_hops, lr, entdrop, reldrop, scoredrop, l3_reg, model_name, decay, ls, w_matrix, bn_list, valid_data_path=None):
    ...
    d2=process_text_file('../../data/QA_data/PQL3H/qa_test_3hop.txt',split=False)
    d3 = process_text_file('../../data/QA_data/PQL3H/qa_dev_3hop.txt', split=False)
...
if args.kg_type == 'half':
    data_path = '../../data/QA_data/PQL3H/qa_train_' + hops + '_half.txt'
else:
    data_path = '../../data/QA_data/PQL3H/qa_train_' + hops + '.txt'
print('Train file is ', data_path)

hops_without_old = hops.replace('_old', '')
valid_data_path = '../../data/QA_data/PQL3H/qa_dev_' + hops_without_old + '.txt'
test_data_path = '../../data/QA_data/PQL3H/qa_test_' + hops_without_old + '.txt'

model_name = args.model
kg_type = args.kg_type
print('KG type is', kg_type)
embedding_folder = '../../pretrained_models/embeddings/' + model_name + '_PQL3H_' + kg_type
