...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default="PQL2H", nargs="?",
                    help="Which dataset to use: FB15k, FB15k-237, WN18 or WN18RR.")
    parser.add_argument("--hops", type=str, default='2', nargs="?",
                    help="hops")
    ...
    if 'half' in args.dataset:
        data_file_path = '../data/QA_data/PQL2H' + '/qa_' + 'train' + '_' + args.hops + 'hop_half.txt'
    else:
        data_file_path = '../data/QA_data/PQL2H' + '/qa_' + 'train' + '_' + args.hops + 'hop.txt'
