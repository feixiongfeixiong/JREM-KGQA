...
data=get_data('../data/QA_data/PQL3H/PQL-3H.txt')
train_data,test_data,valid_data=get_train_test_and_valid(data)
write_data('../data/QA_data/PQL3H/qa_train_3hop.txt', train_data)
write_data('../data/QA_data/PQL3H/qa_test_3hop.txt', test_data)
write_data('../data/QA_data/PQL3H/qa_dev_3hop.txt', valid_data)
# write_data('../data/QA_data/PQL3H/PQL3H-2H_all.txt', data)
